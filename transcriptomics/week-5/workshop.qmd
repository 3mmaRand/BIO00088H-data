...
<!-- You have with 17 columns and 10136 rows. The rows are the genes. -->
...
🎬 Design the code to log~2~ transform the normalised counts using the template given
...
do not because the data is already log~2~ transformed.
...
[contrast used in the DESeq2 analysis](../week-4/workshop.html#4.differential-expression-analysis)
...
using `ggsave()`. You will want to assign the plot to a variable and use code similar to this:	
