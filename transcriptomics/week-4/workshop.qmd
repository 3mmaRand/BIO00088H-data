...
```
Now go to [Differential Expression Analysis](#frog-development-3).
...
Now go to [Differential Expression Analysis](#arabidopisis-3).


## 💉 *Leishmania* 
Import

Now go to [Differential Expression Analysis](#leishmania-mexicana-3).

## 🐭 Stem cells
Import

Now go to [Differential Expression Analysis](#stem-cells-3).
...
Now go to [Add gene information](#frog-development-4).
...
Now go to [Add gene information](#leishmania-mexicana-4).

## 🐭 Stem cells
DE instructions

Now go to [Add gene information](#stem-cells-4).
