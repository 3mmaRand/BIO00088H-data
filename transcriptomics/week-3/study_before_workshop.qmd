...
::: incremental
-   2 plant genotypes: wildtype and spl7 mutant. [This is the genotype
    treatment]{style="color:#009900"}

-   2 copper conditions: sufficient and deficient. [This is the Cu
    treatment]{style="color:#009900"}
...
::: incremental
-   Find genes that are "differentially expressed" between plant types
    and copper conditions e.g. wildtype plants grown under copper
    sufficient and copper deficient conditions
...
-   Based on
    [PRJNA132271](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA132271)[@bernal_transcriptome_2012]
