...
Now go to [Filtering for QC](#frog-development-2).
...
Now go to [Filtering for QC](#arabidopisis-2).
...
Now go to [Filtering for QC](#leishmania-mexicana-2).
...
Now go to [Filtering for QC](#stem-cells-2).
